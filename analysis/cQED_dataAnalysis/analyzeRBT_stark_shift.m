function scaledData = analyzeRBT_stark_shift(data)
...
%Number of overlaps
nbrExpts = 10;
%Number of repeats for partial trace & soft averages
ptraceRepeats = 2;
nbrSoftAvgs = 5;

%Number of twirl sequences at each length
nbrTwirls = [12^2, 12^2, 12^3, 12^2];
...
for expct = 1:nbrExpts
    ...
    if expct == 1, nbrRows = 20; else nbrRows = 50; end
%     nbrRows = 8;
