...
uicontrol(...
    ...
    'String',{  'APS Waveform Generation Board'; 'Command and Control GUI' },...
    'Style','text',...
    'Tag','text1',...
    'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
...
labels(1).position = [1.8 labelTop 26.6 1.2];

labels(2).string = 'Version:';
labels(2).position = [81.8 labelTop 10.4 1.2];
...
uicontrol(...
    ...
    'Units','characters',...
    'HorizontalAlignment','left',...
    'Position',[91.4 labelTop 10.4 1.2],...
    'String',blanks(0),...
    'Style','text',...
    'Value',1,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function drawDacBox(dac, y)
        ...
        labels(6).string = 'V';
        labels(6).position = [50 row2Top 2 1.1];
        ...
        cb(1).callback = 'cb_ll_enable_Callback';
        
        cb(2).tag = sprintf('cb_ll_dc_%i',dac);
        cb(2).position = [39 cbWidth 15 cbTop];
        cb(2).string = 'DC Mode';
        cb(2).callback = 'cb_ll_dc_Callback';
        ...
        dd(1).callback = 'pm_wf_trigger_Callback';
