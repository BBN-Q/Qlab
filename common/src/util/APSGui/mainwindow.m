...
% Added support for multiple DAC boxes to libaps. Updated aps.m for new api.
%
% Revision 1.2  2008/10/23 20:41:35  bdonovan
% First version of CMD Builder GUI that uses C dll to communicate with APS board.
%
...
title(sprintf('Waveform DAC %i',id));
...
handles.guifunctions.trigger_all(handles)
...
handles.guifunctions.pause_all(handles)
set( handles.pb_trigger_all, 'Enable', 'On');
set( handles.pb_pause_all,   'Enable', 'Off');
set( handles.pb_disable_all, 'Enable', 'On');
...
handles.guifunctions.disable_all(handles)
set( handles.pb_trigger_all, 'Enable', 'On');
set( handles.pb_pause_all,   'Enable', 'Off');
set( handles.pb_disable_all, 'Enable', 'Off');
