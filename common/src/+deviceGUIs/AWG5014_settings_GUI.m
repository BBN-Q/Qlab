function [get_settings_fcn, set_settings_fcn] = AWG5014_settings_GUI(parent, bottom, left, name, settings)
% AWG5014_BUILD
%-------------------------------------------------------------------------------
...
% Creation of all uicontrols
		...
		handles.text9 = uicontrol( ...
			...
			'Style', 'text', ...
			'Units', 'characters', ...
			'Position', [43.5 10.6208791208791 15 1], ...
			'String', 'Samp. Rate');
		...
		handles.text12 = uicontrol( ...
			...
			'Style', 'text', ...
			'Units', 'characters', ...
			'Position', [42.6333333333334 14.2472527472528 15 1], ...
			'String', 'Scale Mode');
		...
		handles.samplingRate = uicontrol( ...
			...
			'Style', 'edit', ...
			'Units', 'pixels', ...
			'Position', [236 110.642857142857 35 22], ...
			'BackgroundColor', [1 1 1], ...
			'String', '1.2');

		handles.triggerInterval = uicontrol( ...
			'Parent', handles.uipanel1, ...
			'Tag', 'triggerInterval', ...
			'Style', 'edit', ...
			'Units', 'pixels', ...
			'Position', [318 110 35 22], ...
			'BackgroundColor', [1 1 1], ...
			'String', '');

		% --- POPUP MENU -------------------------------------
		handles.scaleMode = uicontrol( ...
			'Parent', handles.uipanel1, ...
			'Tag', 'scaleMode', ...
			'Style', 'popupmenu', ...
			'Units', 'pixels', ...
			'Position', [222 160.642857142857 74 22], ...
			'BackgroundColor', [1 1 1], ...
			'String', {'Amp/Off','Hi/Lo'});
