...
classdef singleShotFidelityMultiQ < expManager.expBase
    ...
    methods
        %% Class constructor
        function obj = singleShotFidelityMultiQ(data_path, cfgFileName, basename, filenumber)
        ...
        function Init(obj)
            ...
            %Create the sequence of computational basis states
            obj.SingleShotSequence(obj.qubit1, obj.qubit2)
...
%             obj.inputStructure.SweepParams = struct('time', timeSweep);
        ...
        function errorCheckExpParams(obj)
            ...
            if ~isfield(obj.inputStructure.ExpParams, 'OffsetNorm')
                obj.inputStructure.ExpParams.OffsetNorm = 2;
            end
        end
    ...
    methods (Static)
        ...
        SingleShotSequence(qubit1, qubit2)
