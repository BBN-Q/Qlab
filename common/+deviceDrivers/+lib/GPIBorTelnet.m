% CLASS GPIBorTelnet - Provides interface to smartly choose GPIB or
% Ethernet connection (via telnet) based on the address string

% Original author: Blake Johnson

% Adapted for Telnet by Caleb Fried in May 2021 - changed default port to 23, for use with
% telnet (useful for controlling SRS865)
...
classdef GPIBorTelnet < hgsetget
    
    properties (Access = protected)
        interface
        buffer_size = 1048576 % 1 MB buffer
        DEFAULT_PORT = 23; % for TCP/IP communication thru telnet
    end
