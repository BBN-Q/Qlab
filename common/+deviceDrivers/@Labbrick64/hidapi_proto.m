function [methodinfo,structs,enuminfo,ThunkLibName]=hidapi_proto
%HIDAPI_PROTO Create structures to define interfaces found in 'hidapi'.

%This function was generated by loadlibrary.m parser version 1.1.6.37 on Tue Aug  6 10:32:42 2013
%perl options:'hidapi.i -outfile=hidapi_proto.m -thunkfile=hidapi_thunk_pcwin64.c -header=hidapi.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'hidapi_thunk_pcwin64');
% int  hid_init ( void ); 
...
structs.hid_device_info.members=struct('path', 'cstring', 'vendor_id', 'uint16', 'product_id', 'uint16', 'serial_number', 'uint16Ptr', 'release_number', 'uint16', 'manufacturer_string', 'uint16Ptr', 'product_string', 'uint16Ptr', 'usage_page', 'uint16', 'usage', 'uint16', 'interface_number', 'int32', 'next', 'int64Ptr');
methodinfo=fcns;