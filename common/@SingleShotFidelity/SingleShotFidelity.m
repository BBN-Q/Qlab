    ...
    methods
        ...
        function Init(obj, settings)
            ...
            add_measurement(obj.experiment, 'SingleShot',...
                MeasFilters.SingleShot('SingleShot', struct('dataSource', obj.settings.dataSource, 'plotMode', 'real/imag', 'plotScope', true, 'logisticRegression', obj.settings.logisticRegression)));
