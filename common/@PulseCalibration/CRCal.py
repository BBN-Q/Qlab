...
parser.add_argument('caltype',help='1 for length, 2 for phase')
parser.add_argument('length',help='step for length calibration or fixed length in phase calibration (ns)')
