...
ancilla_err = 0.1;%.1; %defines the tolerable false counts for postselection on Q3 = |1>. Optional use (set to 0 to disable)
ndata = 10; %number of adjacent shots between calibration points
ncal = (ndataq+2); %ndataq+2; %2^(ndataq+1); %number of calibration points every ndata shots

if ndataq==2
%indmeas=[1,3,2]; %A, Q1, Q5
indmeas=[1,3,2]; %A, Q1, Q2
segvec_1=ndata+[3,4,2];
%segvec_1=ndata+[2,5,3];

elseif ndataq==3
indmeas=[2,4,1,3]; %A, Q1, Q2, Q5
segvec_1=ndata+[3,5,4,2];

else
    indmeas = [2,5,1,3,4]; %A, Q1, Q2, Q5, Q4
    segvec_1=ndata+[4,6,5,3,2];
