...
#
# Created: Mon Jan 23 17:56:14 2012
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buffer = QtGui.QLineEdit(self.groupBox)
        self.buffer.setObjectName("buffer")
        self.formLayout.setWidget(7, QtGui.QFormLayout.FieldRole, self.buffer)
        ...
        self.passThru = QtGui.QCheckBox(self.groupBox_2)
        self.passThru.setText("")
        self.passThru.setObjectName("passThru")
        self.formLayout_2.setWidget(7, QtGui.QFormLayout.FieldRole, self.passThru)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_17.setText(QtGui.QApplication.translate("Dialog", "passThru", None, QtGui.QApplication.UnicodeUTF8))
