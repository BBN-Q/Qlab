...
processPulseQ2 = pg1.pulse('QId', 'width', CRWidth);
% processPulsesCR = {pgCR.pulse('QId','width', CRWidth)};
processPulsesCR = [{pgCR.pulse('Xtheta', 'pType', 'dragGaussOn', 'width', 3*CRParams.sigma, 'amp', 6950)},...
        {pgCR.pulse('Xtheta', 'width', CRWidth-6*CRParams.sigma, 'pType', 'square', 'amp', 6950)},...
        {pgCR.pulse('Xtheta', 'pType', 'dragGaussOff', 'width', 3*CRParams.sigma, 'amp', 6950)},...
