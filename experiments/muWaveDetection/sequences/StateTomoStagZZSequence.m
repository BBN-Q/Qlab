function StateTomoStagZZSequence(makePlot)
...
for nindex = 1:numsteps
    ...
    prepPulseQ2 = pg2.pulse('X90p', 'duration', pulseLength);
    prepPulseCR21 = {'QId'};
    
    processPulseQ1 = pg1.pulse('QId', 'width', zzdelay);
    processPulseQ2 = pg2.pulse('QId', 'width', zzdelay);
