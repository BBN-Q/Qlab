...
pg21 = PatternGen('dPiAmp', piAmp3, 'dPiOn2Amp', pi2Amp3, 'dSigma', sigma3, 'dPulseLength', pulseLength3, 'correctionT', T3, 'dBuffer', buffer3, 'cycleLength', cycleLength);

length = minWidth:stepsize:(numsteps-1)*stepsize+minWidth;
patseq1   = {pg1.pulse('Xp'),   pg1.pulse('QId', 'width', length)};
%patseq21  = {pg21.pulse('QId'), pg21.pulse('Xp', 'width', length, 'pType', 'square')};
patseq21  = {{'QId'}, {'Xp', 'width', length, 'pType', 'square'}};
