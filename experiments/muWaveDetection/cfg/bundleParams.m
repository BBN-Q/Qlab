...
saveparams2 = {'measDelay', 'delays', 'offsets', 'bufferPaddings', 'bufferResets', 'bufferDelays', 'Ts', '-append', '-v7.3'};

save('pulseParamBundles.mat', saveparams{:});
save('pulseParamBundles.mat', saveparams2{:});